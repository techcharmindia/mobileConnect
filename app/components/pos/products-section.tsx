          ...
          <table className="pos-table pos-table-full">
            <thead>
              <tr>
                ...
                >
                  On-Hand <SortIcon col="quantity" sortBy={sortBy} sortDir={sortDir} />
                </th>
                <th
                  className="pos-sortable"
                ...
                >
                  Stock Warning{" "}
                  <SortIcon col="stock_warning" sortBy={sortBy} sortDir={sortDir} />
                </th>
                <th
                  className="pos-sortable"
                ...
                >
                  Reorder Level{" "}
                  <SortIcon col="reorder_level" sortBy={sortBy} sortDir={sortDir} />
                </th>
                <th
                  className="pos-sortable"
                  onClick={() => toggleSort("retail_price")}
                >
                  Price <SortIcon col="retail_price" sortBy={sortBy} sortDir={sortDir} />
                </th>
                <th>Unit Cost</th>
