  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (saveAndAddAnother) {
        form.reset();
        setItemType("non-serialized");
        setCommission(false);
        setDisplayOnPos(true);
          ...
          {[
            ...
            <Link
              ...
              href={
                item === "Products"
                  ? "/pos"
                  : `/pos?section=${encodeURIComponent(item)}`
              }
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="pos-title">
              ...
              <div className="npf-header-actions">
                ...
                <button className="pos-create" type="submit" disabled={saving} onClick={() => setSaveAndAddAnother(false)}>
            ...
            <section className="pos-filter-card">
              ...
              <div className="pos-create-fields">
                ...
                <label>
                  UPC / barcode
                  <input name="upc" placeholder="Scan or enter barcode" />
                </label>
                <label>
                  Item category
                ...
                {itemType === "serialized" && (
                  <>
                    <label>
                      IMEI
                      <input name="imei" placeholder="Device IMEI" required />
                    </label>
                    <label>
                      Serial number
                      <input name="serial" placeholder="Device serial number" />
                    </label>
                  </>
                )}
                <label>
            ...
            <section className="pos-filter-card">
              ...
              <div className="pos-create-fields">
                ...
                <label className="npf-span-2">
                  Internal notes
                  <textarea name="internalNotes" rows={2} placeholder="Optional notes for the team" />
                </label>
              </div>
            </section>
